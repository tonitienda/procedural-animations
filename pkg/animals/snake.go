...
func AddSnake(headx, heady int, world *world.World) {
	...
	world.AddComponents(snakeHead, &components.LeadMovement{}, &components.Position{X: float32(headx), Y: float32(heady)}, &components.Size{Radius: 10}, &components.Movement{MaxSpeed: 3})
}
